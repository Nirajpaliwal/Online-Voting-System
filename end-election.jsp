...
<body>
    <header>
        ...
        <form method="" action="" class="end-election-form">
            <table border="2px" align="center" width="700"  >
                <caption class="new-election-caption"><h1>End Election</h1></caption>
                    <tr>
                        <th class="table-header">Select Election To End</th>
                    ...
                    <tr>
                        <td colspan="2" align="center"><input type="submit" value="End Election" class="submit2"></td>
                    </tr>
